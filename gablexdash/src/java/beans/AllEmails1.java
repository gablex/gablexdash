...
@ManagedBean
public class AllEmails1 implements Serializable {
    ...
    private BarChartModel initBarModel() {
        ...
        try {
            ...
            String sql="SELECT t.status as status, s.STATUS as statusDesc, COUNT(*) as net FROM tTASKS t  left join tTASKSTATUS s on t.status = s.id WHERE t.status>=0 AND t.msgType=2 group by t.status order by t.status asc";
