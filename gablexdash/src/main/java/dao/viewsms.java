 ...
 * @author kevol
 */
@ManagedBean(name = "viewsms")
@ViewScoped
public class viewsms implements  Serializable{ 
 ...
 private static final String dbPassword = "mysql123";
    ...
    public List<smsout> getsms() throws ClassNotFoundException {

        String sql = "select source_addr,LEFT(destination_addr,6),time_submitted,short_message,status from dbSMPPGateway.tSMSOUT ORDER By id DESC LIMIT 5";
        List<smsout> list = new LinkedList<>();
